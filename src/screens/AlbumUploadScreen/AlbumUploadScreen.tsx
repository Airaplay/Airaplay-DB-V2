...
import { Music, ArrowLeft, AlertCircle, Disc3 } from 'lucide-react';
import { supabase } from '../../lib/supabase';
import AlbumUploadForm from '../../components/AlbumUploadForm';

function AlbumUploadScreen() {
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
              ...
              <p className="font-['Inter',sans-serif] text-gray-600 mb-6">
                This feature is only available to registered creators. Please register as a creator to upload albums.
              </p>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="bg-gradient-to-r from-[#309605] to-[#3ba208] p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-['Inter',sans-serif] text-white/90 text-sm mt-1">
                    Share your music collection with the world
                  </p>
                </div>
              </div>
            </div>
