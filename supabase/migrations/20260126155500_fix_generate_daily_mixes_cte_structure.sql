/*
  # Fix Daily Mix Generation Function - Fix CTE Structure

  1. Restructures CTEs to work properly in a single query flow
  2. Separates mix creation from track distribution
*/

-- Drop and recreate the function with proper CTE structure
