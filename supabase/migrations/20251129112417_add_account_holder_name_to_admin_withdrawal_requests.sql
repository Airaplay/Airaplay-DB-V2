/*
  # Add Account Holder Name to Admin Withdrawal Requests Function

  ## Overview
  Adds account_holder_name to the admin_get_withdrawal_requests function
  so admins can see the account holder information for each withdrawal request.

  ## Changes
  - Add account_holder_name to RETURNS TABLE
  - Add account_holder_name to SELECT query
*/
...
-- Add helpful comment
COMMENT ON FUNCTION admin_get_withdrawal_requests IS 'Gets withdrawal requests with all transaction tracking details including account holder name for admin dashboard';
