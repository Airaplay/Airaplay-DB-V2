/*
  # Fix Typo in Contribution Function
  
  1. Issue
    - Line had `jsondb_build_object` instead of `jsonb_build_object`
    - This is a typo that would cause syntax error
  
  2. Fix
    - Corrected to `jsonb_build_object`
*/
...
BEGIN
  ...
  -- Check cooldown period (FIXED TYPO HERE)
