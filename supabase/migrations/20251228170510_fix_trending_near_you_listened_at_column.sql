/*
  # Fix Trending Near You Songs Function - Correct Column Name
  
  1. Changes
    - Updates `get_trending_near_you_songs` function to use `listened_at` instead of `created_at`
    - The listening_history table uses `listened_at` as the timestamp column
    
  2. Why This Fix?
    - The listening_history table has `listened_at` column, not `created_at`
    - This was causing the function to fail with "column lh.created_at does not exist"
*/
