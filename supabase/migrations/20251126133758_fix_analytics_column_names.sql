/*
  # Fix Analytics Function - Correct Column Names

  1. Changes
    - Fix songs.cover_url -> songs.cover_image_url (line 108)
    - Fix content_uploads.thumbnail_url -> metadata->>'thumbnail_url' (line 120)

  2. Purpose
    - Resolve "column does not exist" errors in analytics
...
COMMENT ON FUNCTION public.get_creator_analytics_optimized IS
  'Optimized analytics function with correct column names: cover_image_url for songs, metadata->>thumbnail_url for content.';
