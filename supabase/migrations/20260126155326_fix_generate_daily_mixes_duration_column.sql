/*
  # Fix Daily Mix Generation Function - Correct Duration Column

  1. Updates function to use correct column name:
     - duration_seconds instead of duration in songs table
