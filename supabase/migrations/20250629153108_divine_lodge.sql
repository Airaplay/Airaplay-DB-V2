/*
  ...
  1. Changes
    - Add `url` column to `banners` table for linking banners to content
    - Update `get_active_banners` function to include the URL in its return values
    - Drop the existing function first to avoid return type conflicts

  2. Security
    - No changes to existing RLS policies
    - New column inherits existing security model
    - Function maintains existing security definer settings
*/
...
-- Recreate the function with the updated return type including url
