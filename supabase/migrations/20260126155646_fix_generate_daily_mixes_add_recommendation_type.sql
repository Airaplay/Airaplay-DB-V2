/*
  # Fix Daily Mix Generation Function - Add recommendation_type

  1. Adds required recommendation_type column to INSERT
*/

-- Drop and recreate the function with recommendation_type
...
BEGIN
  ...
  INSERT INTO daily_mix_tracks (mix_id, song_id, position, recommendation_score, explanation, is_familiar, recommendation_type)
  SELECT
    p.id as mix_id,
    dt.song_id,
    dt.position_in_mix,
    ...
    dt.is_familiar,
    CASE
      WHEN dt.is_familiar THEN 'familiar'
      ELSE 'discovery'
