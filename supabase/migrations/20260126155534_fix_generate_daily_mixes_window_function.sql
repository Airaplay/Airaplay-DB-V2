/*
  # Fix Daily Mix Generation Function - Fix Window Function

  1. Simplifies window function logic for track distribution
  2. Uses simpler approach to distribute tracks across mixes
*/

-- Drop and recreate the function with simplified window functions
